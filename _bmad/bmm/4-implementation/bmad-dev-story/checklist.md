...
## 🔬 TEA Quality Gates (MANDATORY — no exceptions per Heirr directive 2026-04-09)

- [ ] **TEA:ATDD Completed:** Failing acceptance tests were written BEFORE any implementation code (confirm or document why not applicable)
- [ ] **TEA:TA Completed:** Full test suite expansion run AFTER implementation — all new paths covered
- [ ] **TEA:RV Completed:** Quality review pass completed AFTER implementation, BEFORE code review
- [ ] **No TEA Skip:** If any TEA step was skipped, a written justification is in the Dev Agent Record
...
- [ ] **Test Co-location:** Test files placed in `backend/modules/{domain}/__tests__/` (not root `__tests__/` unless cross-cutting)
...
- [ ] **Story Artifact Saved:** Story file copied to `_bmad-output/implementation-artifacts/{story-key}.md` (authoritative record for future agents)
