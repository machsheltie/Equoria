/**
 * Integration Test: Foal Routes — Auth Enforcement & Rate Limiting
 *
 ...
 * - packages/database/prismaClient.mjs (DB client — infrastructure boundary)
 * - logger (permitted infrastructure)
 *
 * REMOVED: foalModel mock — was forbidden. Rate limit tests now verify the
 * 429 response on the Nth+1 request regardless of what status previous
 * requests returned, since foalRateLimiter counts ALL requests
