...
describe('Authentication with HttpOnly Cookies', () => {
  ...
  describe('POST /api/v1/auth/register - Cookie Setting', () => {
  ...
  describe('POST /api/v1/auth/login - Cookie Setting', () => {
  ...
  describe('GET /api/v1/auth/profile - Cookie Authentication', () => {
    let cookieHeader;
  ...
  describe('POST /api/v1/auth/refresh-token - Cookie Refresh', () => {
    let refreshCookie;
    ...
    // and /api/v1/auth/refresh-token mount points receive it.
    ...
    it('should accept the same refreshToken cookie on BOTH /auth/refresh-token and /api/v1/auth/refresh-token (21R-AUTH-1)', async () => {
