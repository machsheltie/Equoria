...
// DELETE /api/v1/users/:id — its controller was removed (Equoria-gfany: players
// cannot delete their accounts). The closed route is locked by
// accountDeletionClosed.integration.test.mjs.
