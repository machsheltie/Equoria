 ...
 */
router.post('/evaluate', authenticateToken, validateFlagEvaluation, async (req, res) => {
  try {
 ...
 */
router.get('/definitions', authenticateToken, validateFlagTypeQuery, async (req, res) => {
  try {
 ...
 */
router.post('/batch-evaluate', authenticateToken, validateBatchEvaluation, async (req, res) => {
  try {
