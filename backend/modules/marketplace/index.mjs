...
export * from './controllers/marketplaceController.mjs';
export * from './routes/marketplaceRoutes.mjs';
...
export { default as marketplaceRoutes } from './routes/marketplaceRoutes.mjs';
