...
import { getBonusTraits, checkBonusEligibility } from '../modules/grooms/index.mjs';
 ...
 */
export async function calculateTraitProbabilityWithBonus(
  horseId,
  traitName,
  baseProbability,
  groomId = null,
 ...
 */
export async function selectTraitsWithGroomBonuses(
  horseId,
  traitCandidates,
  groomId = null,
  maxTraits = 1,
