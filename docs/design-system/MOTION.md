...
| **Decorative ambient motion**     | `magical-pulse`, `shimmer-effect`, `sparkle-trail`, `scroll-entrance`, skeleton sweep, Tailwind `animate-pulse`/`animate-bounce`/`animate-ping` | **Off.** `animation: none` — elements render in their natural end state (skeletons stay solid, toasts appear instantly).                                                                                                                                                                                                                                             |
