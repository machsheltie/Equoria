...
| `.railway/railway.ts`, Netlify config, `.github/`, `.husky/`     | Deployment (Railway IaC, applied with `railway config apply`), CI, ownership, dependency automation, and Git hooks.                                                                   |
