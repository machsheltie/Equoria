...
- `frontend/src/lib/currency-utils.ts`
- `frontend/src/lib/__tests__/currency-utils.test.ts`
- `frontend/src/components/CurrencyDisplay.tsx`
- `frontend/src/components/__tests__/CurrencyDisplay.test.tsx`
- `frontend/src/hooks/api/useTransactionHistory.ts` — stub for AC-3 (backend pending)

**To Modify:**

- `frontend/src/pages/ProfilePage.tsx` — Add CurrencyDisplay below XP section
