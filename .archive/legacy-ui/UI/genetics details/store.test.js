...
describe('Store API Endpoints', () => {
  ...
  beforeAll(async () => {
    ...
    const userResult = await pool.query(
      ...
      ['testuser', 'test@example.com', hashedPassword, 'user', 0, 'basic', false, 1]
    );
  ...
  beforeEach(async () => {
    ...
    try {
      ...
      await client.query(
        'TRUNCATE TABLE users, horses, stables, breeds, conformation_ratings, gait_ratings RESTART IDENTITY CASCADE'
      );
