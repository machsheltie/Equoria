...
type ParsedGraphQLRequest<VariablesType extends GraphQLVariables = GraphQLVariables> =
  | (ParsedGraphQLQuery & {
      query: string;
...
> {
  ...
  predicate(args: { request: Request; parsedResult: GraphQLRequestParsedResult }): Promise<boolean>;
...
type ResponseResolverReturnType<ResponseBodyType extends DefaultBodyType = undefined> =
  ...
  | undefined
  | void;
type MaybeAsyncResponseResolverReturnType<ResponseBodyType extends DefaultBodyType> = MaybePromise<
  ResponseResolverReturnType<ResponseBodyType>
>;
type AsyncResponseResolverReturnType<ResponseBodyType extends DefaultBodyType> = MaybePromise<
  | ResponseResolverReturnType<ResponseBodyType>
  | Iterable<
...
export {
  ...
  type GraphQLHandlerInfo as C,
  type DefaultBodyType as D,
  type GraphQLRequestParsedResult as E,
  type GraphQLCustomPredicateResult as F,
  GraphQLHandler as G,
  type HttpResponseInit as H,
  type GraphQLPredicate as I,
  type JsonBodyType as J,
  isDocumentNode as K,
  type RequestHandlerInternalInfo as L,
  type MaybeAsyncResponseResolverReturnType as M,
  type RequestHandlerArgs as N,
  type RequestHandlerExecutionResult as O,
  ...
  HttpResponse as q,
  type GraphQLHandlerNameSelector as r,
