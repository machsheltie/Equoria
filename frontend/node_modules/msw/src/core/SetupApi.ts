...
export class InMemoryHandlersController implements HandlersController {
  ...
  constructor(private initialHandlers: Array<RequestHandler | WebSocketHandler>) {
    this.handlers = [...initialHandlers];
  }

  public prepend(runtimeHandles: Array<RequestHandler | WebSocketHandler>): void {
...
export abstract class SetupApi<EventsMap extends EventMap> extends Disposable {
  ...
  public use(...runtimeHandlers: Array<RequestHandler | WebSocketHandler>): void {
    invariant(
