...
export type ParsedGraphQLRequest<VariablesType extends GraphQLVariables = GraphQLVariables> =
  | (ParsedGraphQLQuery & {
      query: string;
    ...
    case 'POST': {
      ...
      if (request.headers.get('content-type')?.includes('multipart/form-data')) {
        ...
        const parsedOperations =
          jsonParse<{ query?: string; variables?: GraphQLVariables }>(operations) || {};
 ...
 */
export async function parseGraphQLRequest(request: Request): Promise<ParsedGraphQLRequest> {
