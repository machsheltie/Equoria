...
export function normalizeResponseInit(init: HttpResponseInit = {}): HttpResponseDecoratedInit {
...
export function decorateResponse(response: Response, init: HttpResponseDecoratedInit): Response {
