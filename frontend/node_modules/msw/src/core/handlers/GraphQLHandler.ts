...
export type GraphQLPredicate = GraphQLHandlerNameSelector | GraphQLCustomPredicate;

export function isDocumentNode(value: DocumentNode | any): value is DocumentNode {
  if (value == null) {
    return false;
  }
...
> {
  ...
  static parsedRequestCache = new WeakMap<Request, ParsedGraphQLRequest<GraphQLVariables>>();
  ...
  constructor(
    ...
    const displayOperationName =
      typeof resolvedOperationName === 'function' ? '[custom predicate]' : resolvedOperationName;
