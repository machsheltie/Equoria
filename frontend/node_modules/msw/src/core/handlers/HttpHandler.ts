...
import { matchRequestUrl, Match, Path, PathParams } from '../utils/matching/matchRequestUrl';
...
export type HttpRequestPredicate<Params extends PathParams> = Path | HttpCustomPredicate<Params>;
...
> {
  ...
  async parse(args: { request: Request; resolutionContext?: ResponseResolutionContext }) {
