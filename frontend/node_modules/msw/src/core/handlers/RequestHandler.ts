...
import { AsyncIterable, Iterable, isIterable } from '../utils/internal/isIterable';
import type { ResponseResolutionContext } from '../utils/executeHandlers';
import type { MaybePromise } from '../typeUtils';
import { StrictRequest, HttpResponse, DefaultUnsafeFetchResponse } from '../HttpResponse';
import type { HandlerKind } from './common';
import type { GraphQLRequestBody } from './GraphQLHandler';

export type DefaultRequestMultipartBody = Record<string, string | File | Array<string | File>>;
...
export type MaybeAsyncResponseResolverReturnType<ResponseBodyType extends DefaultBodyType> =
  MaybePromise<ResponseResolverReturnType<ResponseBodyType>>;

export type AsyncResponseResolverReturnType<ResponseBodyType extends DefaultBodyType> =
  MaybePromise<
...
export interface RequestHandlerArgs<HandlerInfo, HandlerOptions extends RequestHandlerOptions> {
  info: HandlerInfo;
...
> {
  static cache = new WeakMap<StrictRequest<DefaultBodyType>, StrictRequest<DefaultBodyType>>();
    ...
    return async (info): Promise<ResponseResolverReturnType<any>> => {
      if (!this.resolverIterator) {
        ...
        this.resolverIterator =
          Symbol.iterator in result ? result[Symbol.iterator]() : result[Symbol.asyncIterator]();
      }
