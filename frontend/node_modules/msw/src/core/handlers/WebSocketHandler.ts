...
export class WebSocketHandler {
  ...
  public predicate(args: { url: URL; parsedResult: WebSocketHandlerParsedResult }): boolean {
...
function createStopPropagationListener(handler: WebSocketHandler) {
  return function stopPropagationListener(event: Event) {
    const propagationStoppedAt = Reflect.get(event, 'kPropagationStoppedAt') as string | undefined;
