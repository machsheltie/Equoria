...
import { LifeCycleEventEmitter, LifeCycleEventsMap, SharedOptions } from '~/core/sharedOptions';
...
export type ServiceWorkerInstanceTuple = [ServiceWorker | null, ServiceWorkerRegistration];

export type FindWorker = (scriptUrl: string, mockServiceWorkerUrl: string) => boolean;
