...
export class SetupWorkerApi extends SetupApi<LifeCycleEventsMap> implements SetupWorker {
 ...
 */
export function setupWorker(...handlers: Array<RequestHandler | WebSocketHandler>): SetupWorker {
