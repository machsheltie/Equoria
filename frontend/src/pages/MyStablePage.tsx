  ...
  <div className="space-y-4" data-testid="legacy-hall-tab">
    ...
    {MOCK_HALL_OF_FAME.length === 0 ? (
      <div className="flex flex-col items-center justify-center min-h-48 text-center p-8">
        ...
        <p className="text-white/50 font-medium">No retired horses yet</p>
        <p className="text-white/30 text-sm mt-1">
          Horses retired at level 8+ are inducted into the Hall of Fame.
        </p>
      </div>
    ) : (
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-white/40 mb-6">
          ...
          <span>/</span>
          <span className="text-white/70">My Stable</span>
        </div>
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white/90">🐴 My Stable</h1>
            <p className="text-sm text-white/50 mt-0.5">
              Your stable profile and legacy hall of fame
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 p-5 rounded-xl bg-white/3 border border-white/8 text-sm text-white/40">
          <h3 className="font-semibold text-white/60 mb-2">About My Stable</h3>
