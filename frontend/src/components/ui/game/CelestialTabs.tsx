/**
 * CelestialTabs / CelestialAccordion — array-API adapter over the Celestial
 * GoldTabs + GameCollapsible primitives.
 *
 * Equoria-1nlw: renamed from the retired pre-Celestial tabs adapter and
 * relocated into the Celestial Night game namespace. Behaviour is
...
interface CelestialTabsProps {
  ...
  /** Controlled active tab. When provided, CelestialTabs becomes controlled and
...
interface CelestialAccordionProps {
  items: CelestialAccordionItem[];
