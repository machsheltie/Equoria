 ...
 *
 * Owns all visual styling for tooltips. Naked tooltip.tsx is the native
 * (dependency-free) tooltip primitive (Equoria-rkgq9.3).
...
const GameTooltipContent = React.forwardRef<HTMLDivElement, TooltipContentProps>(
