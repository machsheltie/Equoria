    ...
    return (
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-[var(--text-primary)]">Error loading foal development</p>
  ...
  if (!development) {
    return (
      <div className="text-center py-12" data-testid="milestone-evaluation-empty">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[var(--alpha-bg-midnight-50)] mb-4">
          <Award className="h-8 w-8 text-[var(--text-secondary)]" />
        </div>
        <p className="text-[var(--text-secondary)] text-sm">No development data available</p>
      </div>
    );
  }
    ...
    <div className="space-y-6" data-testid="milestone-evaluation-display">
      ...
      <div className="glass-panel rounded-lg p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-bold text-[var(--text-primary)]">Foal Development</h3>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-[var(--text-secondary)]">Bonding Level</span>
            <span className="text-sm font-medium text-[var(--text-primary)]">
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-[var(--text-secondary)]">Stress Level</span>
            <span className="text-sm font-medium text-[var(--text-primary)]">{development.stressLevel}</span>
          </div>
