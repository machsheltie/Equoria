...
describe('CompetitionFilters', () => {
  ...
  describe('Date Range Filter', () => {
    it('highlights active date range filter', () => {
      ...
      expect(weekButton).toHaveClass('bg-[var(--status-info)]', 'text-[var(--text-primary)]');

      // Other buttons should not be active
      const allButton = screen.getByTestId('filter-date-all');
      expect(allButton).not.toHaveClass('bg-[var(--status-info)]');
    });
  ...
  describe('Entry Fee Filter', () => {
    it('highlights active entry fee filter', () => {
      ...
      expect(freeButton).toHaveClass('bg-[var(--status-info)]', 'text-[var(--text-primary)]');
