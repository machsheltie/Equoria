...
| --- | --------------- | ----------------------------------------------------------------------------------------------------------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Equoria-3ewqy   | Stale retryableTransactionWrapping sentinel pin (count 1→2)                                                 | Sonnet high | ✅ CODE LANDED — 3ewqy's line-61 fix landed in ce116a8de; residual gate red was a DIFFERENT pin (showController/showEscrowTx from 8pb6w) fixed+landed as f6add9a87 (new issue Equoria-8vn7k). Sentinel GREEN 28/28. Both AWAIT user closure. Do NOT re-dispatch. |
