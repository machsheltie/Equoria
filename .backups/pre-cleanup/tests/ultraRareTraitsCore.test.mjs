...
describe('Ultra-Rare & Exotic Traits Core Functionality', () => {
  ...
  describe('Mechanical Effects Integration', () => {
    ...
    test('should apply ultra-rare competition effects correctly', () => {
      ...
      const result = applyUltraRareCompetitionEffects(
        horseWithBornLeader,
        baseScore,
        competitionContext
      );
      ...
      const presenceEffect = result.appliedEffects.find(
        (effect) => effect.effect === 'competition_presence'
      );
    ...
    test('should handle multiple ultra-rare traits correctly', () => {
      ...
      const stormtouchedEffect = result.appliedEffects.find(
        (effect) => effect.trait === 'Stormtouched'
      );
