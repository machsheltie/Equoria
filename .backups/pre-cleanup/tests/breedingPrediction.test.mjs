...
describe('Breeding Prediction System', () => {
  ...
  beforeEach(async () => {
    ...
    testStallion = await prisma.horse.create({
      data: {
        ...
        epigeneticModifiers: {
          positive: ['sensitive', 'noble'],
          negative: [],
          hidden: ['quick_learner'],
        },
      },
    });
  ...
  describe('Inheritance Probability Logic', () => {
    it('should calculate trait inheritance probabilities from parent history', async () => {
      ...
      const { calculateInheritanceProbabilities } = await import(
      ...
      const sensitiveInheritance = predictions.traitProbabilities.find(
        (t) => t.traitName === 'sensitive'
      );
    ...
    it('should calculate flag inheritance scores', async () => {
      ...
      const { calculateFlagInheritanceScore } = await import(
        '../services/breedingPredictionService.mjs'
      );
    ...
    it('should calculate temperament influence modifiers', async () => {
      ...
      const { calculateTemperamentInfluence } = await import(
        '../services/breedingPredictionService.mjs'
      );
  ...
  describe('Child Prediction Algorithms', () => {
    it('should predict trait categories with probability ranges', async () => {
      ...
      expect(prediction.estimatedTraitCount.max).toBeGreaterThan(
        prediction.estimatedTraitCount.min
      );
