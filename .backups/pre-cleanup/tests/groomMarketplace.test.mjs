...
describe('🏪 Groom Marketplace System', () => {
  ...
  describe('Configuration Validation', () => {
    it('should have valid marketplace configuration', () => {
      ...
      const qualityTotal = Object.values(MARKETPLACE_CONFIG.QUALITY_DISTRIBUTION).reduce(
        (a, b) => a + b,
        0
      );
      const specialtyTotal = Object.values(MARKETPLACE_CONFIG.SPECIALTY_DISTRIBUTION).reduce(
        (a, b) => a + b,
        0
      );
