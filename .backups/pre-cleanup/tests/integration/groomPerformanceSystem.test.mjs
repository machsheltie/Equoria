...
describe('Groom Performance System', () => {
  ...
  describe('API Endpoints', () => {
    ...
    it('should get performance configuration', async () => {
      ...
      expect(response.body.data.minInteractionsForReputation).toBe(
        PERFORMANCE_CONFIG.MIN_INTERACTIONS_FOR_REPUTATION
      );
      expect(response.body.data.excellenceBonusThreshold).toBe(
        PERFORMANCE_CONFIG.EXCELLENCE_BONUS_THRESHOLD
      );
    });
